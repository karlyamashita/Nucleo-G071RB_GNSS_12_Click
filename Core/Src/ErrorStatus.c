...
void GetErrorString(int errorCode, char *str)
{
    ...
    case NO_INFO_STRING:
    	...
    	break;
    case NO_SLAVE_RAIL_ADDRESS:
    	strcpy(str, "ERROR-No Slave Rail Address");
    	break;
    case NO_INTERPOLATION:
    	strcpy(str, "ERROR-No Interpolation data");
    	break;
    ...
    case LTM46xx_NVM:
        ...
        break;
    case ADC_CALIBRATION_NOT_SET:
    	strcpy(str, "ERROR-ADC Calibration not set");
    	break;
    ...
    case INTERPOLATION_ERROR:
    	strcpy(str, "ERROR-Interpolation not valid");
    	break;
    case NO_TELEMETRY_RATE:
    	strcpy(str, "ERROR-No Telemetry rate");
    	break;
    case STRING_NOT_VALID:
    	strcpy(str, "ERROR-String is not valid");
    	break;
        // for debug
    case ERR_1:
